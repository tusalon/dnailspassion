...
const urlsToCache = [
  ...
  '/dnailspassion/vendor/react.production.min.js',
  '/dnailspassion/vendor/react-dom.production.min.js',
  '/dnailspassion/vendor/babel.min.js',
  ...
  '/dnailspassion/utils/legacy-ios-fallback.css?v=20260619-ios15',
...
self.addEventListener('push', event => {
  ...
  const options = {
    ...
    icon: '/dnailspassion/icons/icon-192x192.png',
    badge: '/dnailspassion/icons/icon-96x96.png',
    tag: payload.tag || 'rservasroma',
    data: {
      url: payload.url || '/dnailspassion/admin.html',
      ...(payload.data || {})
    }
  };
...
self.addEventListener('notificationclick', event => {
  ...
  const targetUrl = event.notification?.data?.url || '/dnailspassion/admin.html';
  event.waitUntil(
